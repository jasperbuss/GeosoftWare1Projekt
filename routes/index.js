...
router.get('/parkzusch/', function(req, res, next) {
  res.render('parkzusch', {});
});

router.get('/parkzusch/:id/', function(req, res, next) {
  res.render('parkzusch', {loadParkplatz: req.params.id});
});
